...
attribute_list = ['Number of Parts', 'Number of Total Elements', 'Number of Versions', 'Number of Workspaces', 'Parts Missing Mass', 'application/step', 'application/stl', 'onshape-app/com.onshape.api-explorer', 'onshape-app/drawing', 'onshape-app/materials', 'onshape/assembly', 'onshape/billofmaterials', 'onshape/featurestudio', 'onshape/partstudio', 'newSketch', 'extrude', 'revolve', 'sweep', 'cPlane', 'loft', 'thicken', 'enclose', 'fillet', 'chamfer', 'draft', 'rib', 'shell', 'hole', 'linearPattern', 'circularPattern', 'curvePattern', 'mirror', 'booleanBodies', 'splitPart', 'transform', 'wrap', 'deleteBodies', 'modifyFillet', 'deleteFace', 'moveFace', 'replaceFace', 'offsetSurface', 'fill', 'extendSurface', 'helix', 'fitSpline', 'projectCurves', 'bridgingCurve', 'compositeCurve', 'mateConnector', 'importDerived', 'assignVariable', 'compositePart', 'sheetMetalStart', 'sheetMetalFlange', 'sheetMetalHem', 'sheetMetalTab', 'sheetMetalMakeJoint', 'sheetMetalCorner', 'sheetMetalBendRelief', 'sheetMetalJoint', 'sheetMetalEnd', 'importForeign', 'MATE_CONNECTOR', 'FASTENED', 'REVOLUTE', 'SLIDER', 'PLANAR', 'CYLINDRICAL', 'PIN_SLOT', 'BALL', 'PARALLEL', 'TANGENT', 'MATE_GROUP', 'GEAR', 'RACK_AND_PINION', 'SCREW', 'LINEAR_MATE', 'LINEAR_PATTERN', 'CIRCULAR_PATTERN', 'UNACCOUNTED_ASY_FEATURE', 'EXPLODED_VIEW', 'Number of Assembly Features', 'asm_unique_parts', 'asm_total_instances', 'asm_linked_parts', 'asm_sub_asms', 'surfaceText', 'application/x_b', 'onshape-app/de.cadenas.partcommunity', 'Number of Parts Features', 'BETWEEN_ENTITIES', 'image/jpeg', 'image/png', 'application/dwg', 'application/dwt', 'application/dxf', 'application/pdf', 'application/vnd.oasis.opendocument.spreadsheet', 'autolayout', 'hoseRouting', 'video/mp4', 'application/sldprt', 'application/x_t', 'application/iges', 'onshape-app/com.solidpartners.catalog', 'onshape-app/io.clara.visualizer', 'onshape-app/net.3dexchange.onshape', 'Unnamed: 109', 'application/octet-stream', 'text/plain', 'Unnamed: 112', 'Unnamed: 113', 'Beam', 'myFeature', 'bender', 'fixPCB', 'kicadImport', 'measureValue', 'onshape-app/com.onerender.app', 'Unnamed: 89', 'laserJoint', 'onshape-app/com.materialise.i', 'SpurGear', 'application/sldasm', 'application/zip', 'Unnamed: 101', 'text/html', 'Unnamed: 105', 'Unnamed: 106', 'profile', 'text/csv', 'onshape-app/com.openbom.integrated.onshape.stage', 'application/acis', 'Unnamed: 114', 'application/prt', 'onshape-app/design.intact', 'application/ipt', 'image/gif', 'onshape-app/Onshape-Demo/bom', 'profileGen', 'application/catpart', 'slot', 'WingProfile', 'xyzCSV', 'onshape-app/space.grid.slicer', 'onshape-app/ZMECSOFTXVSHAPECAMTD5SHCJORRKEY7M5DUDVY=', 'Unnamed: 119', 'portFeature', 'threadCreator']
